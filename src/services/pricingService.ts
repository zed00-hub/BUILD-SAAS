...
export const DEFAULT_PRICING_CONFIG: PricingConfig = {
    plans: [
        ...
        },
        {
            ...
            name: 'E-COM STARTER',
            basePoints: 500,
            prices: { DZD: 2900, USD: 14.99 },
            description: 'Special plan for e-commerce merchants.',
            features: [
                { count: '✓', label: 'Virtual Try-On Access' },
                { count: '✓', label: 'Product Description' },
                { count: '✓', label: 'Ad Creatives' },
                { count: '✗', label: 'No Social Media Tool' },
            ],
            isPopular: false,
